...
recover();
            ...
            <p>An empty block or block-like construct <em>may</em> be closed immediately after it is
                ...
                multiple blocks: <code>if</code>/<code>else</code> or <code>try</code>/<code>catch</code>/<code>finally</code>).
            </p>
            <p>Example:</p>
...
someMethod(foo, {
  a: 0, b: 1,
            ...
            <p>Class literals (whether declarations or expressions) are indented as blocks. Do
                ...
                <code>@extends</code> JSDoc annotation unless the class extends a templatized type.
            </p>
            <p>Example:</p>
...
currentEstimate) / 2.0f;
                ...
                <li>
                    ...
                    <ol>
                        <li>Exception: A blank line between two consecutive properties definitions in
                            ...
                            blank lines are used as needed to create <em>logical groupings</em> of fields.
                        </li>
                    </ol>
                </li>
            ...
            <p>Beyond where required by the language or other style rules, and apart from
                ...
                following places <strong>only</strong>.
            </p>
            <ol>
