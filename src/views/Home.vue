<template>
    <div class="home-container content">
        ...
        <guide-block id="types" title="Types">
            ...
            <pre class="prettyprint"><code>const foo = 1;<br>let bar = foo;<br><br>bar = 9;<br>console.log(foo, bar); // => 1, 9</code></pre>
            <p id="types-complex">
            ...
            <pre class="prettyprint"><code>const foo = [1, 2];<br>const bar = foo;<br><br>bar[0] = 9;<br>console.log(foo[0], bar[0]); // => 9, 9</code></pre>
        </guide-block>
        ...
        <guide-block id="references" title="References">
            ...
            <pre class="prettyprint"><code>// bad<br>var a = 1;<br>var b = 2;<br><br>// good<br>const a = 1;
const b = 2;</code></pre>
            <p>
                If you must reassign references, use <code>let</code> instead of <code>var</code>.
            </p>
            <pre class="prettyprint"><code>// bad<br>var count = 1;<br>if (true) {<br>    count += 1;<br>}</code></pre>
            <p>
                Note that both <code>let</code> and <code>const</code> are block-scoped.
            </p>
            <pre class="prettyprint"><code>// const and let only exist in the blocks they are defined in.<br>{<br>    let a = 1;<br>    const b = 1;<br>}<br>console.log(a); // ReferenceError<br>console.log(b); // ReferenceError</code></pre>
        </guide-block>
        ...
        <guide-block id="objects" title="Objects">
            ...
            <pre class="prettyprint"><code>// bad<br>const item = new Object();<br><br>// good<br>const item = {};</code></pre>
            <p>
                Use object method shorthand.
            </p>
            <pre class="prettyprint"><code>// bad<br>const atom = {<br>    value: 1,<br><br>    addValue: function (value) {<br>        return atom.value + value;<br>    }<br>};<br><br>// good<br>const atom = {<br>    value: 1,<br><br>    addValue(value) {<br>        return atom.value + value;<br>    }<br>};</code></pre>
            <p>
                Use property value shorthand.
            </p>
            <pre class="prettyprint"><code>const typography = 'Avenir';<br><br>// bad<br>const obj = {<br>    typography: typography<br>};<br><br>// good<br>const obj = {<br>    typography<br>};</code></pre>
            <p>
                Group your shorthand properties at the beginning of your object declaration.
            </p>
            <pre class="prettyprint"><code>const typeface = 'Avenir';<br>const category = 'Modern';<br><br>// bad<br>const obj = {<br>    fontWeight: 'bold',<br>    typeface,<br>    fontStyle: 'italic',<br>    category<br>};<br><br>// good<br>const obj = {<br>    category,<br>    typeface,<br>    fontWeight: 'bold',<br>    fontStyle: 'italic'<br>};</code></pre>
            <p>
                Only quote properties that are invalid identifiers.
            </p>
            <pre class="prettyprint"><code>// bad<br>const bad = {<br>    'foo': 3,<br>    'bar': 4,<br>    'data-blah': 5<br>};<br><br>// good<br>const good = {<br>    foo: 3,<br>    bar: 4,<br>    'data-blah': 5<br>};</code></pre>
            <p>
        ...
        <guide-block id="arrays" title="Arrays">
            ...
            <pre class="prettyprint"><code>// bad<br>const items = new Array();<br><br>// good<br>const items = [];</code></pre>
            <p>
                Use Array push instead of direct assignment to add items to an array.
            </p>
            <pre class="prettyprint"><code>const someStack = [];<br><br>// bad<br>someStack[someStack.length] = 'abracadabra';<br><br>// good<br>someStack.push('abracadabra');</code></pre>
            <p>
                Use array spreads <code>...</code> to copy arrays.
            </p>
            <pre class="prettyprint"><code>// bad<br>const len = items.length;<br>const itemsCopy = [];<br>let i;<br><br>for (i = 0; i < len; i += 1) {<br>    itemsCopy[i] = items[i];<br>}<br><br>// good<br>const itemsCopy = [...items];</code></pre>
            <p>
            ...
            <pre class="prettyprint"><code>const foo = document.querySelectorAll('.foo');<br>const nodes = Array.from(foo);</code></pre>
            <p>
        ...
        <guide-block id="destructuring" title="Destructuring">
            ...
            <pre class="prettyprint"><code>// bad<br>function getFullName(user) {<br>    const firstName = user.firstName;<br>    const lastName = user.lastName;<br><br>    return `${firstName} ${lastName}`;<br>}<br><br>// good<br>function getFullName(user) {<br>    const { firstName, lastName } = user;<br>    return `${firstName} ${lastName}`;<br>}<br><br>// best<br>function getFullName({ firstName, lastName }) {<br>    return `${firstName} ${lastName}`;<br>}</code></pre>
            <p>
                Use array destructuring.
            </p>
            <pre class="prettyprint"><code>const arr = [1, 2, 3, 4];<br><br>// bad<br>const first = arr[0];<br>const second = arr[1];<br><br>// good<br>const [first, second] = arr;</code></pre>
        </guide-block>
